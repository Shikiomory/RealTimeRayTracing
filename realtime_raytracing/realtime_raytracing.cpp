...
int main()
{
    ...
    MovCamera cam(WIDTH, RATIO, Point3(0.0f, 0.0f, 10.0f), Point3(0.0f, 0.0f, -5.0f), Vector3(0.0f, 1.0f, 0.0f), 90);
    ...
    scene.world.add(Sphere(Point3(0.0f, 0.0f, -2.0f), 1.0f, material_1));
    scene.world.add(Sphere(Point3(2.0f, 0.0f, -3.0f), 2.0f, material_3));
    for (int i = 0; i < 20; i++) {
        //scene.world.add(Sphere(Point3(fast_random(-5.0f, 5.0f), fast_random(-5.0f, 5.0f), fast_random(-5.0f, 5.0f)), 1.0f, material_1));
        //scene.world.add(Sphere(Point3(fast_random(-5.0f, 5.0f), fast_random(-5.0f, 5.0f), fast_random(-5.0f, 5.0f)), 1.0f, material_3));
        //scene.world.add(Sphere(Point3(fast_random(-5.0f, 5.0f), fast_random(-5.0f, 5.0f), fast_random(-5.0f, 5.0f)), 1.0f, material_4));
        //scene.world.add(Sphere(Point3(fast_random(-5.0f, 5.0f), fast_random(-5.0f, 5.0f), fast_random(-5.0f, 5.0f)), 1.0f, material_5));
        scene.world.add(Sphere(Point3(fast_random(-5.0f, 5.0f), fast_random(-5.0f, 5.0f), fast_random(-5.0f, 5.0f)), fast_random(0.0f, 1.0f), material_1));
        scene.world.add(Sphere(Point3(fast_random(-5.0f, 5.0f), fast_random(-5.0f, 5.0f), fast_random(-5.0f, 5.0f)), fast_random(0.0f, 1.0f), material_3));
        scene.world.add(Sphere(Point3(fast_random(-5.0f, 5.0f), fast_random(-5.0f, 5.0f), fast_random(-5.0f, 5.0f)), fast_random(0.0f, 1.0f), material_4));
        scene.world.add(Sphere(Point3(fast_random(-5.0f, 5.0f), fast_random(-5.0f, 5.0f), fast_random(-5.0f, 5.0f)), fast_random(0.0f, 1.0f), material_5));
    }

    scene.world.add(Box(Point3(0.0f, 0.0f, 7.0f), Point3(1.0f, 1.0f, 5.0f), material_5));
    scene.world.add(Cilinder(Point3(fast_random(-5.0f, 5.0f), fast_random(-5.0f, 5.0f), fast_random(-5.0f, 5.0f)), Point3(0.0f, 1.0f, -3.0f), 1.0f, material_2));
    //world.add(Plane(Point3(0.0f, -1.0f, 0.0f), Vector3(0.0f, 1.0f, 0.0f), material_2));
    scene.world.add(Cilinder(Point3(2.0f, -4.0f, 5.0f), Point3(4.0f, 0.5f, 5.0f), 1.5f, material_4));
    ...
    auto bvh_tree = std::make_unique<Bvh>(scene.world);
    scene.world.clear();
    scene.world.add(std::move(bvh_tree));

    scene.world.add(Plane(Point3(0.0f, -6.0f, 0.0f), Vector3(0.0f, 1.0f, 0.0f), material_2));
    std::cout << scene.world.bounding_box().x.min << " " << scene.world.bounding_box().x.max;
    ...
    sf::Vector2i center(cam.get_window_width() / 2, cam.get_window_height() / 2);
